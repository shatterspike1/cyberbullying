...
var Survey = React.createClass({ displayName: 'Survey',
    ...
    render: function(){
        return (
            <div className="survey">
                <div className="firstQuestion row">
                    <h6>Is there any cyberaggressive behaviour in the online posts? Mark yes if there is at least one negative word/comment and or content with intent to harm someone or others.</h6>
                    <div className="p row">
                        <button>{'Yes'}</button>
                        <button>{'No'}</button>
                    </div>
